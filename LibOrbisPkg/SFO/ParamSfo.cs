...
namespace LibOrbisPkg.SFO
{
  ...
  public static class SfoData
  {
    ...
    public static readonly string[] Attribute2Names = new[]
    {
      ...
      "Enlarge FMEM 256MB",
      "SELF 2MiB page mode／2-Mbyte pages are not used／16",
      "SELF 2MiB page mode／2-Mbyte pages are reserved for mapping .text and .rodata sections of ELF and PRX files／17",
      ...
      "The application runs on PS5 system and adheres to TRC R4211／24",
      "Unknown(25)",
      "Unknown(26)",
      "The application uses a forced 800MHz as a GPU core clock counter (This value also affects the behavio of NEO mode for PS4 Pro)／27",
      "Unknown(28)",
      "Unknown(29)",
      "Unknown(30)",
      "Unknown(31)",
    ...
    public static readonly string[] Download0Sizes = new[]
    {
      "000 MiB (Disable)",
      "064 MiB (for SDK4000)",
      "128 MiB (for SDK4000)",
    ...
    public static readonly string[] Download1Sizes = new[]
    {
      "00.00 MiB (Disable)",
      "03.25 GiB (3328MiB)",
      "06.50 GiB (6656MiB)",
    ...
    public static readonly Dictionary<string, string> KeyDescriptions = new Dictionary<string, string>() {
      ...
      { "SELF_2MIB_PAGE_AMOUNT",
        "Reserved 2-Mbyte Page Amount (in bytes)" },
