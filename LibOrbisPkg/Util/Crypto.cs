...
namespace LibOrbisPkg.Util
{
  public static class Crypto
  {
    ...
    /// </summary>
    public static (byte[] tweakKey, byte[] dataKey) PfsGenEncKey(byte[] ekpfs, byte[] seed, bool newCrypt = false)
    {
    ...
    public static byte[] DecryptEEKPfs(byte[] eekpfs, RSAKeyset keyset)
    {
      ...
      using(var rsa = RSA.Create())
      {
        ...
        return rsa.Decrypt(eekpfs, RSAEncryptionPadding.OaepSHA256); //rsa.DecryptValue <== NotSupportedException, This method call is not supported.
      }
    }
